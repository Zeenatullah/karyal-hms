			...
			<div class="contact">
				<div class="contact_container">
					<div class="container">
						...
						{{-- Form Section --}}
								<div class="users-frm col-lg-12 mt-5" style="border-radius: 50px; background-color: #42465cfa; color: white; padding: 50px;" >
									{!! Form::open(['action' => 'FoodController@store', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
										<div class="dropdown input-group">
											<div class="offset-lg-1"></div>
											<select class="btn btn-secondary dropdown-toggle col-lg-10" name="foodId" required style="background-color: white; color: black">
												@if(count($foods) > 0)
													<div class="dropdown-menu col-lg-12" aria-labelledby="dropdownMenuButton">
														<option selected disabled style="color:black">@lang('text.Choose a food')</option>
														@foreach ($foods as $food)
														<a class="dropdown-item" href="#">
															<option style="color:black" value="{{$food->id}}">
																<h4>
										...
										<div class="row">
											<div class="offset-lg-1"></div>
											<div class="dropdown col-lg-4 input-group">
												<select class="dropdown-toggle col-lg-12" name="bookedRoomId" required style="background-color: white; color: black;">
											...
											<div class="dropdown col-lg-4 input-group ">
												<select class="dropdown-toggle col-lg-12" name="time" required style="background-color: white; color: black;">
													<div class="dropdown-menu col-lg-12" aria-labelledby="dropdownMenuButton">
											...
											<div class="col-lg-2 input-group" style="background-color: inherit; color: black; border: none">
