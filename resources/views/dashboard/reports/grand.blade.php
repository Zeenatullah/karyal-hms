...
@section('daily')
	...
	<div class="row">
		...
		<li class=" btn btn-primary" style="width: 80px">
			<a href="/dboard/grandPrint" style="color: white;">@lang('text.Details')</a>
		</li>
	</div>
@endsection
@section('contents')
		...
		<div class="col-xs-6 col-md-3">
			<div class="panel panel-default">
				<div class="panel-body easypiechart-panel">
					...
					<div class="easypiechart" id="easypiechart-orange" data-percent="{{ $totalBookedRooms }}" ><span class="percent">{{ $totalBookedRooms }}</span></div>
				</div>
			</div>
		</div>
		<div class="col-xs-6 col-md-3">
